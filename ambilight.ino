/******************
This file should be uploaded to your Arduino. 
You do not need a UNO for this project, a dirt cheap Nano will do the trick.
Change LED_TYPE, MAX_LEDS and LED_PINS/DATA_PIN accordingly. I use 3 on mine.
******************/
